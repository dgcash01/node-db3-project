...
Select Product.ProductName, OrderDetail.Quantity from OrderDetail inner join Product on Product.Id = OrderDetail.ProductId where OrderDetail.OrderId = 10251
